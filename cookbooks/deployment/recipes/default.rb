...
node.set[:nats_server][:host] ||= cf_local_ip
node.set[:ccdb][:host] ||= cf_local_ip
node.set[:acmdb][:host] ||= cf_local_ip
node.set[:uaadb][:host] ||= cf_local_ip
node.set[:postgresql][:host] ||= cf_local_ip
node.set[:redis_resque][:host] ||= cf_local_ip
node.set[:vcap_redis][:host] ||= cf_local_ip
node.set[:serialization_data_server][:host] ||= cf_local_ip
